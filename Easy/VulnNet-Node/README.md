...
2. Точка входу (Initial Access / Foothold)
   ...
   2.1. Експлуатація вразливості (Ping Test)
      Для перевірки виконання коду (RCE) було створено Payload, який використовує префікс `_$$ND_FUNC$$_` та миттєвий виклик функції `()` в кінці для виконання системної команди `ping`:
